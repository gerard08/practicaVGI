...
//	afx_msg void OnUpdateObjecteTexteSTROKE(CCmdUI* pCmdUI);
	...
	afx_msg void OnTexturaMapa();
	afx_msg void OnUpdateTexturaMapa(CCmdUI* pCmdUI);
	afx_msg void OnTexturaGallinas();
	afx_msg void OnUpdateTexturaGallinas(CCmdUI* pCmdUI);
};
