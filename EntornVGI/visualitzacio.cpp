...
glm::mat4 Projeccio_Orto(int minx, int miny, GLsizei w, GLsizei h)
{   
	glm::mat4 MatriuOrto;
	...
	MatriuOrto = glm::ortho(-10.f, 10.f, float(-10.f / (A)), float(10 / (A)), -10.f, 10.f);
...
//								tipus de projecció definit a la variable prj.
	...
	switch (prj)
	{
		case 0: //planta
			...
			//	//ens posem 10 punts per sota de l'eix Y
			//	glm::vec3 eye(0.f, -10.f, 0.f);
			...
			//	//eix v de la camera
			//	//la posem a l'eix X
			//	glm::vec3 eixv(1.f, 0.f, 0.f);

			//	MatriuVista = glm::lookAt(eye, point, eixv);
			//}
			//else
			//{
				//posicio de la camera en coordenades mon
				...
				//MatriuVista = glm::rotate(MatriuVista, glm::radians(90.f), glm::vec3(0, 0, 1));
			/*}*/

			MatriuVista = glm::rotate(MatriuVista, glm::radians(180.f), glm::vec3(0, 1, 0));
		...
		case 1://isomètrica
			{
				...
				//	//eix v de la camera
				//	//la posem a l'eix Y
				//	glm::vec3 eixv(0.f, 1.f, 0.f);

				//	MatriuVista = glm::lookAt(eye, point, eixv);

				//	//rotem la vista 45 graus sobre l'eix Z per fer la vista "picada"
				//	MatriuVista = glm::rotate(MatriuVista, glm::radians(45.f), glm::vec3(0, 0, 1));
				//	//rotem 45 graus sobre l'eix Y per posar-nos al mitg dels eixos X i Z
				//	MatriuVista = glm::rotate(MatriuVista, glm::radians(45.f + 180.f), glm::vec3(0, 1, 0));
				//}
				//else
				//{
					//posicio de la camera en coordenades mon
		...
		case 2: //alçat
			...
			//	//posicio de la camera en coordenades mon
			//	//ens posem 10 punts per sota de l'eix Z
			//	glm::vec3 eye(-10.f, 4.f, 0.f);

			//	//punt on volem que miri la camera
			//	//mirem cap al centre de coordenades
			//	glm::vec3 point(0.f, 3.f, 0.f);
		...
		case 3: //perfil
			...
			//	//posicio de la camera en coordenades mon
			//	//ens posem 10 punts per sota de l'eix Z
			//	glm::vec3 eyep(0.f, 4.f, 10.f);

			//	//punt on volem que miri la camera
			//	//mirem cap al centre de coordenades
			//	glm::vec3 pointp(0.f, 3.f, 0.f);

			//	//eix v de la camera
			//	//la posem a l'eix Y
			//	glm::vec3 eixvp(0.f, 1.f, 0.f);

			//	MatriuVista = glm::lookAt(eyep, pointp, eixvp);
			//}
			//else
			//{
				//posicio de la camera en coordenades mon
				...
				//punt on volem que miri la camera
				//mirem cap al centre de coordenades
				glm::vec3 pointp(0.f, 0.f, 0.f);

				//eix v de la camera
				//la posem a l'eix Y
				glm::vec3 eixvp(0.f, 0.f, 1.f);

				MatriuVista = glm::lookAt(eyep, pointp, eixvp);

				//MatriuVista = glm::rotate(MatriuVista, glm::radians(90.f), glm::vec3(1, 0, 0));
			//}
